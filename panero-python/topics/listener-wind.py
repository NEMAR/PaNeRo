...
conn.start()
conn.connect(user, password, wait=True, headers={ 'client-id': 'wolfhagen-wind' })
conn.subscribe(destination, 'wolfhagen-wind', ack='auto', headers={ 'activemq.subscriptionName': 'wolfhagen-wind', 'selector': "category = 'wind'" })
